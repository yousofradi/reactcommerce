    ...
    <div className="admin-layout">
      <aside className="admin-sidebar">
        <div className="admin-brand-header">
          <div className="admin-brand-title store-name-text">لوحة التحكم</div>
          <a href="/" target="_blank" className="admin-store-preview">
        ...
        <nav className="admin-nav">
          ...
          <Link href="/admin/collections" className={pathname?.includes("/admin/collections") ? "active" : ""}>
            <svg viewBox="0 0 24 24"><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path></svg>
            المجموعات
          </Link>
          <Link href="/admin/shipment" className={pathname?.includes("/admin/shipment") ? "active" : ""}>
          ...
          <a href="#" className="logout" onClick={(e) => { e.preventDefault(); console.log("Logout"); }}>
